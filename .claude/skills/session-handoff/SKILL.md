...
2. **Pull state from these sources (in order):**
   - Plan files referenced this session (check `/home/kevin/.claude/plans/` if a plan was mentioned).
   ...
   - Memory files written or updated (`/home/kevin/.claude/projects/-home-kevin-projects-Kevbot-Toolkit/memory/`).
