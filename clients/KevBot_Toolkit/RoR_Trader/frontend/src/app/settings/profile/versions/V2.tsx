...
const profileData = {
  ...
  plan: { name: 'Free Subscriber', price: 0, period: 'forever' },
  nextTier: { name: 'Strategy Builder', price: 29, features: ['Strategy Builder access', 'Mass Backtesting', 'Forward testing', 'Up to 10 subscriptions'] },
};
...
export default function SettingsProfileV2() {
          ...
          if (tab === 'Profile') return (
            <div className="space-y-6">
              ...
              <Card>
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs mt-1" style={{ color: 'var(--text-muted)' }}>Member since {profileData.memberSince}</p>
                  </div>
                </div>
              </Card>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <MetricCard label="Strategies Created" value={usageStats.strategiesCreated.toString()} />
                <MetricCard label="Backtests Run" value={usageStats.backtestsRun.toString()} />
                <MetricCard label="Alerts Received" value={usageStats.alertsReceived.toString()} />
                <MetricCard label="Login Streak" value={`${usageStats.loginStreak} days`} positive />
              </div>
              ...
              <Card>
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <p className="text-xl font-bold">{profileData.plan.name}</p>
                  </div>
                ...
                <div className="p-4 rounded-lg" style={{ background: 'var(--accent-muted)', border: '1px solid var(--accent)' }}>
                  <div className="flex items-center justify-between mb-2">
                    <p className="font-semibold">Upgrade to {profileData.nextTier.name}</p>
                    <p className="font-bold" style={{ color: 'var(--accent)' }}>${profileData.nextTier.price}/mo</p>
                  </div>
                  <ul className="space-y-1 mb-3">
                    {profileData.nextTier.features.map((f) => (
              ...
              <Card>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    { device: 'Safari on iPhone', location: 'New York, US', current: false, lastSeen: '2h ago' },
                  ].map((session, i) => (
