...
function DetailView({
  ...
  return (
    <div>
      <PageHeader
        title={pack.name}
        subtitle={`${pack.category} -- ${pack.version} -- Used in ${pack.strategiesUsing} strategies -- Last modified ${pack.lastModified}`}
        backHref="#"
        actions={
          <div className="flex items-center gap-3">
      ...
      <TabBar tabs={['Parameters', 'Plot Settings', 'Outputs & Triggers', 'Preview', 'Code', 'Danger Zone']}>
        {(tab) => (
          <div>
            ...
            {tab === 'Outputs & Triggers' && <OutputsTriggersTab pack={pack} />}
...
export default function UserPacksV2() {
