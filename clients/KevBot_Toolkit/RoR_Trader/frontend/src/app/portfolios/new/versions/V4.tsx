...
export default function PortfolioNewV4() {
  ...
  function renderSparkline(curve: number[], color: string, w: number, h: number) {
    ...
    return (
      <svg width={w} height={h} viewBox={`0 0 ${w} ${h}`} style={{ display: 'block' }}>
        ...
        <path d={fillPath} fill={`url(#spark-${color.replace(/[^a-zA-Z0-9]/g, '')})`} />
    ...
    <div>
        ...
        <div style={{ animation: 'fadeIn 0.3s ease' }}>
          <Card className="mb-6">
            ...
            <p className="text-sm mb-6" style={{ color: 'var(--text-muted)' }}>
              Name your portfolio and set your account parameters.
            </p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem', maxWidth: '600px' }}>
              <div style={{ gridColumn: '1 / -1' }}>
                ...
                <input
                  ...
                  style={{ ...inputStyle, fontSize: '1rem', padding: '0.75rem 1rem' }}
                  autoFocus
                />
              </div>
              <div>
              ...
              <div>
                <label className="text-xs block mb-2" style={{ color: 'var(--text-muted)' }}>Risk Tolerance</label>
            ...
            <div className="col-span-3">
              <Card className="mb-0">
                ...
                <p className="text-sm mb-4" style={{ color: 'var(--text-muted)' }}>
                  Click strategies to add them to your portfolio. Each card shows its equity curve.
                </p>
      ...
      {currentStep === 'risk' && (
        <div style={{ animation: 'fadeIn 0.3s ease' }}>
            ...
            <Card>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem' }}>
                ...
                <div style={{ width: '100%', maxWidth: 300 }}>
                  <label className="text-xs block mb-1.5 text-center" style={{ color: 'var(--text-muted)' }}>
          ...
          {/* KPI Preview at this risk level */}
          {strategies.length > 0 && (
              ...
              <Card>
                ...
                <div className="rounded-lg p-3" style={{ background: 'var(--bg-input)', height: 220 }}>
                  <svg width="100%" height="100%" viewBox={`0 0 ${svgW} ${svgH}`} preserveAspectRatio="none">
                    <defs>
                      <linearGradient id="eqGradNewV4" x1="0" y1="0" x2="0" y2="1">
                    ...
                    {/* Per-strategy dashed lines */}
                    {strategies.map((s, i) => {
                      const max = Math.max(1, ...s.equityCurve);
                    ...
                    {combinedFillPath && (
                      <path d={combinedFillPath} fill="url(#eqGradNewV4)" stroke="none" />
                    )}
                    {combinedPath && (
