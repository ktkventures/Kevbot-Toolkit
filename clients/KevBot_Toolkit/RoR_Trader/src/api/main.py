...
def create_app() -> FastAPI:
    ...
    from api.routers.mentions import router as mentions_router
    ...
    from api.routers.r_session import router as r_session_router
    ...
    app.include_router(m_session_router)
    app.include_router(r_session_router)
