...
TEMPLATES: Dict[str, Dict] = {
    "atr_based": {
        ...
        "stop_params": ["stop_atr_mult"],
        "target_params": ["target_atr_mult"],
    ...
    "fixed_dollar": {
        ...
        "stop_params": ["stop_amount"],
        "target_params": ["target_amount"],
    ...
    "percentage": {
        ...
        "stop_params": ["stop_pct"],
        "target_params": ["target_pct"],
    ...
    "rr_target": {
        ...
        "category": "Target",
        "description": "Take profit at a fixed multiple of the stop-loss distance. Works with any stop loss pack.",
        "has_stop": False, "has_target": True, "stop_only": False, "target_only": True,
        "parameters_schema": {
            "rr_ratio": {"type": "float", "default": 2.0, "min": 0.5, "max": 10.0, "label": "R:R Ratio"},
        },
        "stop_params": [],
        "target_params": ["rr_ratio"],
        "stop_summary": "",
    ...
    "rr_ratio": {
        ...
        "stop_params": ["stop_method", "stop_atr_mult", "stop_amount", "stop_pct", "lookback", "padding"],
        "target_params": ["rr_ratio"],
    ...
    "atr_trailing": {
        ...
        "stop_params": ["stop_atr_mult", "trail_atr_mult", "trail_activation_r"],
        "target_params": ["target_atr_mult"],
    ...
    "breakeven_stop": {
        ...
        "stop_params": ["stop_atr_mult", "be_activation_r", "be_offset"],
        "target_params": ["target_atr_mult"],
...
def create_default_packs() -> List[RiskManagementPack]:
    defaults = [
        ...
        RiskManagementPack(
            ...
            base_template="swing",
            version="Default",
            description="Swing-based stop: recent swing low/high with padding",
            enabled=True,
            is_default=True,
            parameters={"lookback": 5, "padding": 0.05},
        ),
        RiskManagementPack(
            id="rr_target_2r",
            base_template="rr_target",
            version="2R",
            description="Take profit at 2x the stop-loss distance",
            enabled=True,
            is_default=True,
            parameters={"rr_ratio": 2.0},
        ),
        RiskManagementPack(
            id="rr_target_3r",
            base_template="rr_target",
            version="3R",
            description="Take profit at 3x the stop-loss distance",
            enabled=True,
            is_default=True,
            parameters={"rr_ratio": 3.0},
        ),
        RiskManagementPack(
